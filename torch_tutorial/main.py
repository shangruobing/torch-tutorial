...
from torch_tutorial.visualization import visualize
...
def main():
    ...
    for epoch in range(args.epochs):
        loss = train(train_dataloader, model, criterion, optimizer, scheduler, device)
        test_loss, accuracy = test(test_dataloader, model, criterion, device)
